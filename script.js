...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // =======================================================
// ===== MOTOR 3: FILTROS DO CARDÁPIO INTELIGENTE V2.0 =====
// =======================================================
...
const curatorshipContent = {
    ...
    // Adicione textos para outros filtros como 'risoto', 'sopa', etc. se desejar.
};
...
if (allFilterButtons.length > 0 && productCards.length > 0) {
    allFilterButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Lógica da Curadoria
            if (filter !== 'all' && curatorshipContent[filter]) {
